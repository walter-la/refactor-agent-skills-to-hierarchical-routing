...
👉 **你可以直接查看 [examples/unpacked_results/dummy-toolkit/](examples/unpacked_results/dummy-toolkit/)，體驗「重整後」的企業級目錄結構與安全合約到底長得多嚴謹。**
...
2.  提供你的技能清單給 Agent (可參考 `examples/inputs/`)。
